...
class MainActivity : AppCompatActivity() {
    ...
    private val botList = listOf("Ngoc trinh", "Chi Pu", "Lan Ngọc", "Trâm Anh")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        customBotMessage("Chào bạn mình là ${botList[random]}, Mình giúp gì được cho bạn nhể :D")
    }
        ...
        GlobalScope.launch {
            ...
            withContext(Dispatchers.Main) {
                ...
                when (response) {
                    ...
                    OPEN_SEARCH -> {
                        val site = Intent(Intent.ACTION_VIEW)
                        val searchTerm: String? = message.substringAfterLast("tim kiem")
